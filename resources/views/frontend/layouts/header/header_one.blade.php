                                                    ...
                                                    <div class="col">
                                                        <ul class="sub-menu">
                                                            @foreach ($columnSet as $category)
                                                                <li>
                                                                    <a
                                                                        href="{{ route('category.courses', $category->slug) }}">{{ $category->lang_title }}</a>
                                                                </li>
                                                            @endforeach
                                                        </ul>
                                                    </div>
                    ...
                    <ul class="header-extra">
                                ...
                                <li class="shopping-mini-cart">
                                    <a href="#" class="cart-btn">
                                        <svg width="16" height="18" viewBox="0 0 16 18" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M14.3212 4.16667H12.205C11.9291 1.82368 9.93149 0 7.51563 0C5.09976 0 3.10212 1.82368 2.82625
                                        ...
                                        17.7778H14.3212C14.7047 17.7778 15.0156 17.4669 15.0156 17.0833V4.86111C15.0156 4.47757 14.7047 4.16667 14.3212 4.16667ZM7.51563 1.38889C9.16438 1.38889
                                         ...
                                         7.63889V5.55556H13.6267V16.3889Z" fill="#333333" />
                                        </svg>
                                        <input type="text"
                        ...
                        @if (auth()->check())
                            <li class="user-profile-dropdown">
                                <a href="#" class="dropdown-toggle" id="userProfileDropdown"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="{{ getFileLink('40x40', Auth()->user()->images) }}" width="32"
                                        alt="User">
                                    <span>{{ Auth()->user()->first_name }}</span>
                                </a>
                                <div class="user-profile-dropdown-content dropdown-menu dropdown-menu-end profile-sidebar"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('change.app.setting') }}" class="ajax_form" method="post">@csrf
                        ...
                        <input type="hidden" class="global_currency" name="currency_code"
                            value="{{ userCurrency() }}">
                        <div class="row g-0">
                            <div class="col-lg-6">
                                ...
                                <ul class="list-groups p-r-15 p-r-md-0">
                                    @foreach (app('languages') as $language)
                                        <li class="{{ $language->locale == userLanguage() ? 'active' : '' }}">
                                            <a href="javascript:void(0)" data-name="lang"
