                    ...
                    <div class="row gx-3 counter-items-v3">
                        ...
                        <div class="col-6">
                            <div class="counter-item m-b-45 m-b-sm-30" data-aos="fade-up" data-aos-delay="400">
                                <div class="icon">
                                    <img src="{{ static_asset('frontend/img/icons/live-streaming.svg') }}"
                                        alt="live streaming">
                                </div>
                                <div class="content">
                                    <div class="counter-wrap">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block">
                            <div class="left-content" data-aos="fade-up" data-aos-delay="200">
                                <img src="{{ getFileLink('266x250', $section->image_1) }}" class="main-image"
                                    alt="Benefit Image">
                                <div class="element-wrapper">
                                    <span class="element"></span>
                                    <img src="{{ static_asset('frontend/img/particle/dot-pattern.svg') }}"
                                        class="animate-float-bob-y" alt="Dot Pattern">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 align-self-end">
                            <div class="right-content" data-aos="fade-up" data-aos-delay="400">
                                <div class="element-wrapper">
                                    ...
                                    <img src="{{ static_asset('frontend/img/particle/dot-pattern.svg') }} "
                                        class="animate-float-bob-x" alt="Dot Pattern">
                                </div>
                                <img src="{{ getFileLink('296x285', $section->image_2) }}" class="main-image"
                                    alt="Benefit Image">
                            </div>
                        </div>
                    </div>
