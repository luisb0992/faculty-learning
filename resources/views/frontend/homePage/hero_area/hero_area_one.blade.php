                        ...
                        @if (setting('hero_main_action_btn_enable') != 0)
                            <li>
                                <a href="{{ url(setting('hero_main_action_btn_url')) }}" class="template-btn">
                                    {{--  {{ setting('hero_main_action_btn_label', $lang) }}  --}}
                                    {{ __('show_all_courses') }}
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex gap-3 justify-content-end align-items-end">
                                <img src="{{ setting('header1_hero_image1') && @is_file_exists(setting('header1_hero_image1')['image_240x240']) ? get_media(setting('header1_hero_image1')['image_240x240']) : get_media('images/default/hero/header-01.png') }}"
                                    alt="Hero Image" class="image-one">
                                <img src="{{ setting('header1_hero_image2') && @is_file_exists(setting('header1_hero_image2')['image_196x196']) ? get_media(setting('header1_hero_image2')['image_196x196']) : get_media('images/default/hero/header-02.png') }}"
                                    alt="Hero Image" class="image-two m-r-15">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="d-flex gap-3 justify-content-end align-items-start">
                                <img src="{{ setting('header1_hero_image3') && @is_file_exists(setting('header1_hero_image3')['image_284x284']) ? get_media(setting('header1_hero_image3')['image_284x284']) : get_media('images/default/hero/header-03.png') }}"
                                    alt="Hero Image" class="image-three">
                                <img src="{{ setting('header1_hero_image4') && @is_file_exists(setting('header1_hero_image4')['image_212x212']) ? get_media(setting('header1_hero_image4')['image_212x212']) : get_media('images/default/hero/header-04.png') }}"
