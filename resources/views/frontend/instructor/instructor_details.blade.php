                        ...
                        <div class="instructor-badges">
                            <ul>
                                @foreach ($badges as $badge)
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $badge->badge_name }}">
                                        <img src="{{ static_asset($badge->logo) }}" alt="{{ $badge->badge_name }}">
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <div class="instructor-social-activity">
                        <div class="instructor-follow-wrapper">
                            <ul class="following-and-followers">
                                <li>
                                    <span class="following_counter">
                                        {{ ReadableHumanNumber($instructor->user->following->count()) }}
                                    </span>{{ __('following') }}
                                </li>
                                <li>
                                    <span class="follow_counter">
                                        {{ ReadableHumanNumber($instructor->user->followers->count()) }}
                                    </span>{{ __('followers') }}
                                </li>
                            </ul>
                            @if (auth()->check() && auth()->id() != $instructor->user_id)
                                <div class="follow-btn" id="followArea">
                                    <a href="javascript:void(0)" data-follow-id="{{ $instructor->user->id }}"
                                        ...
                                        <i class="fal fa-minus ms-0 m-r-5"></i>{{ __('Unfollow') }}</a>

                                    <a href="javascript:void(0)" data-follow-id="{{ $instructor->user->id }}"
                                        data-value="1" id="follow"
                                        class="template-btn follow-instructor {{ !$is_followed ? '' : 'd-none' }}">
                                        <i class="fal fa-plus ms-0 m-r-5"></i>{{ __('follow') }}</a>
                                    @include('components.frontend_loading_btn', [
                                        'class' => 'template-btn follow-instructor',
                                    ])
                                </div>
                            @endif
                        </div>
                    ...
                    <div class="instructor-details-tabs main-tabs">
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link {{ session()->has('contact') ? '' : 'active' }}"
                                    id="about-instructor-tab" data-bs-toggle="pill" data-bs-target="#about-instructor"
                                    type="button" role="tab" aria-controls="about-instructor"
                                    aria-selected="true">{{ __('about') }}
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                ...
                                @if (setting('hide_instructor_contact_information') != '1')
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link {{ session()->has('contact') ? 'active' : '' }}"
                                            ...
                                            aria-controls="instructor-contact" aria-selected="false">{{ __('contact') }}
                                        </button>
                                    </li>
                                @endif
                            @endif
                        ...
                        <div class="instructor-details-tab-content tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade {{ session()->has('contact') ? '' : 'show active' }}"
                                id="about-instructor" role="tabpanel" aria-labelledby="about-instructor-tab">
                                ...
                                @if ($courses->nextPageUrl())
                                    <div class="row">
                                        <div class="col-lg-12 text-center">
                                            <a href="javascript:void(0)" class="template-btn load_more"
                            ...
                            @if (addon_is_activated('book_store'))
                                <div class="instructor-book-tab tab-pane fade m-b-10" id="instructor-book"
                                    role="tabpanel" aria-labelledby="instructor-book-tab">
                            ...
                            @if (setting('hide_all_instructor_contact_information_from_everywhere') != '1')
                                ...
                                <div class="instructor-contact-tab m-b-30 tab-pane fade {{ session()->has('contact') ? 'show active' : '' }}"
                                    id="instructor-contact" role="tabpanel" aria-labelledby="instructor-contact-tab">
                                    <div class="row">
                                                ...
                                                <form method="POST" action="{{ route('instructor.contact') }}"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 mt-3">
                                                            ...
                                                            <textarea class="form-control" name="message" id="message" placeholder="{{ __('message') }}"></textarea>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.success) {
                            ...
                            $(that).closest('.follow-btn').find('.loading_button').addClass(
                                'd-none');
                            if (status == 1) {
