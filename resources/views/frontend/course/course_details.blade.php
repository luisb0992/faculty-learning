                                                ...
                                                <div class="col-sm-6">
                                                    <div class="team-member-item">
                                                        ...
                                                        <div class="member-content">
                                                            <h5 class="title">
                                                                <a
                                                                    href="{{ route('instructor.details', $user->instructor->slug) }}">{{ $user->name }}
                                                                </a>
                                ...
                                <div class="col-lg-12">
                                    <div class="course-details-info">
                                        ...
                                        <div class="single-course-info">
                                            ...
                                            @if (!auth()->check() || auth()->user()->user_type == 'student')
                                                <div class="enroll-and-share d-flex d-lg-block gap-3 align-items-center">
                                                    <div class="course-enroll cart_area d-flex align-items-center gap-4">
                                                        @if ($is_enrolled)
