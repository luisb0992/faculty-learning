<header class="template-header header-layout-1 course-item-active {{ isHome() ? 'nav-white-color position-absolute' : (isAuth() ? 'bg-white' : '')}}">
                ...
                <div class="header-left">
                    ...
                    <nav class="nav-menu d-none d-lg-block">
                        <ul>
                                                    ...
                                                    <div class="col">
                                                        <ul class="sub-menu">
                                                            @foreach($columnSet as $category)
                                                                <li><a href="{{ route('courses') }}?category_ids={{ $category->id }}">{{ $category->lang_title }}</a></li>
                                                            @endforeach
                                                        </ul>
                                                    </div>
                                                @endif
                            ...
                            @if(isDemoMode())
                                <li>
                                    <a href="#" data-bs-toggle="dropdown">{{__('home')}}</a>
