                ...
                <div class="col-sm-auto col-6">
                    <ul class="contact-info">
                        @if (!empty(setting('topbar_phone')))
                            <li><a href="tel:{{str_replace(' ', '', setting('topbar_phone'))}}"><i class="fal fa-phone"></i>{{setting('topbar_phone')}}</a></li>
                        @endif
                            ...
                            <li class="user-dropdown">
                                ...
                                <ul class="dropdown-list">
                                    ...
                                    <li class="dropdown-list-item">
                                        <a href="{{ route('my-profile') }}"><i class="far fa-user"></i>{{__('my_profile')}}</a>
                                    </li>
                                    <li class="dropdown-list-item">
                                        <a href="{{ route('wallet') }}"><i class="fas fa-clipboard-list"></i>{{__('my_account')}}</a>
                                    </li>
                                    <li class="dropdown-list-item">
                                        <form method="POST" action="{{ route('student.logout') }}"> @csrf
                                            <a href="{{route('student.logout')}}" onclick="event.preventDefault(); this.closest('form').submit();"><i class="fas fa-sign-out-alt"></i>{{__('logout')}}</a>
                                        </form>
                                    </li>
                                      @else
                                        <li class="dropdown-list-item">
                                            <a href="{{ route('login')  }}"><i class="fas fa-clipboard-list"></i>{{__('login')}}</a>
                                        </li>
                                    @endif
                                </ul>
                            </li>
                ...
                <div class="header-right">
                    <ul class="header-extra">
                        ...
                        <li class="d-none d-md-block">
                            <a href="{{ route('course.purchase') }}" class="template-btn">{{__('start_a_new_course')}}</a>
                        </li>
                        @else
                            <li class="d-none d-md-block">
                                <a href="{{ route('login') }}" class="template-btn">{{__('start_a_new_course')}}</a>
                            </li>
                        @endif
