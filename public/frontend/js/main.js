...
// ====== 49. Demo Switcher / Theme Options Modal
// function demoSwitcherModal() {
//     $(".switcher-btn").click(function (e) {
//         e.stopPropagation();
//         $(".demo-switcher-modal").toggleClass("active");
//     });

//     $(document).click(function (event) {
//         if (
//             !$(event.target).closest(".demo-switcher-modal").length &&
//             !$(event.target).hasClass("switcher-btn")
//         ) {
//             $(".demo-switcher-modal").removeClass("active");
//         }
//     });
...
//     var demoSwitcherInnerContent = $('.demo-switcher-inner-content');
//     var demoSwitcherInner = $('.demo-switcher-inner');

//     if (demoSwitcherInnerContent.get(0).scrollHeight > 420) {
//         demoSwitcherInner.css('padding-inline-end', '10px');
//     } else {
//         demoSwitcherInner.css('padding-inline-end', '0');
//     }
// }

// ====== 50. Window Load Subscription Modal
