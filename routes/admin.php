...
Route::group(['prefix' => localeRoutePrefix()], function () {
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'verified', 'adminCheck', 'PermissionCheck']], function () {
        ...
        Route::post('update-home-page', [WebsiteSettingController::class, 'updateHomePage'])->name('update.home.page.builder');
        ...
        Route::post('header-content', [HeaderSettingController::class, 'updateHeaderMenu'])->name('header.content');
        ...
        Route::post('call-to-action', [WebsiteSettingController::class, 'saveCtaSetting'])->name('save.cta');

        //website popup setting
        Route::get('become-instructor-content', [WebsiteSettingController::class, 'instructorContent'])->name('website.instructor_content');
        Route::post('become-instructor-content', [WebsiteSettingController::class, 'saveInstructorContent'])->name('save.instructor_content');
